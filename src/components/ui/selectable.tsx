...
const cardBase =
  "relative flex min-h-11 w-full items-start gap-3 rounded-[var(--radius-choice)] border bg-surface p-4 text-left cursor-pointer transition-colors";
const cardIdle = "border-border hover:border-primary/50 hover:bg-surface-muted";
const cardOn = "border-primary bg-primary-subtle";
const focusRing =
      ...
      {options.map((o) => {
        ...
        return (
          <label key={o.value} className="block">
            ...
            />
            <span className={cn(cardBase, on ? cardOn : cardIdle, focusRing)}>
      ...
      {options.map((o) => {
        ...
        return (
          <label key={o.value} className="block">
            ...
            <span className={cn(cardBase, "items-center", on ? cardOn : cardIdle, focusRing)}>

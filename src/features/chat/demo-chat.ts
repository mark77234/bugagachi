...
export const DEMO_CHAT_TOPICS: DemoChatTopic[] = [
  ...
  },
  {
    ...
    answer:
      "아니에요. 부가가치의 자격 확인과 추천은 입력한 정보를 바탕으로 한 참고 결과예요. 최종 자격은 모집기관이 공고 기준과 제출 서류를 심사해 결정하므로 실제 공고를 반드시 확인해야 해요.",
    actions: [
  ...
  },
  {
    ...
    answer:
      "먼저 무주택·소득·자산 등 기본 조건으로 신청 가능성이 있는 유형을 확인해요. 그다음 예산, 희망 지역과 생활 취향을 반영해 주택을 정렬하고 추천 이유를 함께 보여드려요. 추천 점수는 법적 자격 판정과 별개예요.",
    actions: [
      { label: "맞춤 추천 시작하기", href: "/eligibility" },
...
export const FALLBACK_ANSWER: Omit<DemoChatTopic, "key" | "question" | "keywords"> = {
  answer:
    "임대 유형, 자격 확인, 준비 서류, 신청 절차와 추천 방식에 관한 기본 질문을 안내해 드려요. 아래 추천 질문을 선택하거나, 구체적인 자격과 공고 내용은 공식 기관에서 확인해 주세요.",
  actions: [
    { label: "맞춤 추천 시작하기", href: "/eligibility" },
    { label: "전체 주택 지도 보기", href: "/map" },
  ],
